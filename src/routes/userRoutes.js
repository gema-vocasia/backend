...
//Khusus admin
userRoutes.get("/admin/users", auth, userController.ReadByAdmin); // Untuk Mendapatkan Semua User
userRoutes.put("/admin/update/user/:_id", auth, userController.UpdateByAdmin); // Untuk Memperbarui User
userRoutes.delete("/admin/delete/user/:_id", auth, userController.DeleteByAdmin); // Untuk Menghapus User
