...
router.patch(
  "/campaign/:_id/status/:newStatus",
  auth,
  campaignController.updateStatusCampaign
); // Untuk Memperbarui Status Campaign
router.patch(
  "/campaign/:_id/transfer/:newStatus",
  auth,
  campaignController.updateStatusTransfer
); // Untuk Memperbarui Status Transfer
router.patch(
  "/campaign/:_id/urgent/:newStatus",
  auth,
  campaignController.updateUrgentCampaign
);
